...
```bash
cp -r compose-score /path/to/your-project/.claude/skills/
```
...
compose-score is for pieces that will be published. Not for everything written.
