...
Incident triage. Ingest a monitoring alert, trace it to the commit that introduced it, and route it to one of four outcomes: fix, file, escalate, or suppress.
