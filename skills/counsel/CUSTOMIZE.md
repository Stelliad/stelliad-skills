# Customizing counsel for Your Organization

This guide walks you through adapting counsel to your org's contracts, tooling, and risk profile.
...
**Customization:**
Save these as your baseline documents. counsel will check your actual practice against them.
...
```
your-org/
├── counsel-spec.md (this SPEC.md, customized)
├── counsel-customize.md (this CUSTOMIZE.md, customized)
...
**Trigger:** `counsel`, `AI compliance check`, `audit our AI tools`, etc.
