# gauntlet: Content Quality Gate Specification
...
```
gauntlet: "Why the migration took nine months"
...
```
gauntlet: "Why I'm leaving my role at the end of the quarter"
...
**A visible gap marker is an information gap by construction.** `campfire` writes
...
**Where a source file exists, check the specifics against it.** `campfire`
