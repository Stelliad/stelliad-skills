# compose-from-interview: Content Extraction Specification
...
ones. `compose-score` treats any visible marker as an information gap by construction
and will never resolve one for you.

Hand the draft to a scoring pass. `compose-score` in this repository is built for it.
